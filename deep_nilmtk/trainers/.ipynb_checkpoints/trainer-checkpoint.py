...
class Trainer:
    ...
    def __init__(self, imp, hparams):
        ...
        self.model_class = self.hparams['model']  if 'model' in hparams else __models__[self.hparams['backend']][self.hparams['model_name']]['model']
        self.loader_class = self.hparams['loader']  if 'loader' in hparams else __models__[self.hparams['backend']][self.hparams['model_name']]['loader']
        self.appliances = []
        self.models = {}
