...
def get_exp_parameters():
    ...
    # Specification that output needs to cover multiple appliances
    parser.add_argument('--multi_appliance', default=False, type=bool)

    # Customisation of Pre/Postprocessing
    ...
    # Type of Disaggregation Model (incl. Architecture)
    ...
    # Dummy for Notebook Functionality
